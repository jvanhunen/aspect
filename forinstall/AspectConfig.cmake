...
FIND_PACKAGE(deal.II 8.5.0 QUIET REQUIRED HINTS /ddn/data/dgl6jv1/Progs/ASPECT_20181001/deal.ii-candi/tmp/build/deal.II-v9.0.0)
SET(Aspect_INCLUDE_DIRS "/usr/local/include")
SET(Aspect_VERSION "2.2.0-pre")
...
MACRO(ASPECT_SETUP_PLUGIN _target)
  ...
  IF(ASPECT_USE_PETSC)
    MESSAGE(STATUS "  with World Builder=ON")
    SET_PROPERTY(TARGET ${_target}
      APPEND PROPERTY COMPILE_DEFINITIONS ASPECT_WITH_WORLD_BUILDER="1")
  ENDIF() 
  ...
  TARGET_COMPILE_DEFINITIONS( ${_target} PRIVATE ASPECT_SOURCE_DIR="/ddn/data/dgl6jv1/Progs/git/aspect")
