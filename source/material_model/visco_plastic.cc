...
namespace aspect
{
  namespace MaterialModel
  {
      ...
      for (unsigned int j=0; j < volume_fractions.size(); ++j)
        {
          ...
          // Step 3: strain weakening & depletion strengthening
      ...
      if (this->introspection().compositional_name_exists("maximum_melt_fraction"))
        {
          ...
          composition_mask.set(melt_index,false);
        }
             ...
             MaterialModel::MaterialModelOutputs<dim> &out) const
    {
      ...
      // TODO
      // check if depletion strengthening is applied: 
      // const unsigned int apply_depletion_strengthening = depletion_strengthening.apply();
